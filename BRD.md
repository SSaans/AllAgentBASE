...
> ⚠️ 当前**没有任何已立项的子项目**。第一个子项目由用户拍板后，规划 Agent 在下一轮产出子项目 BRD，开发 Agent 才能开始编码。
...
- **CHANGELOG 归档**：保留最近 15 条记录，超出部分移入 `CHANGELOG.archive.md`（由规划 Agent 或归档工具处理）
- **文件夹职责**：
